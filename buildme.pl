...
my $dirsToExcludeForReadyNasi386 = "i386-freebsd-64int sparc-linux sparc-unknown-linux-gnu x86_64 darwin-thread-multi darwin MSWin32-x86 arm-linux armhf-linux powerpc-linux 5.10 5.12 5.14 5.16 5.18 PreventStandby icudt46b.dat";
my $dirsToExcludeForReadyNasSparc = "i386-freebsd-64int i386 x86_64 darwin-thread-multi darwin arm-linux armhf-linux MSWin32-x86 powerpc-linux 5.10 5.12 5.14 5.16 5.18 PreventStandby icudt46l.dat";
